...
public class VillageManager {
	 ...
	 * @param maxDistance Maximum distance around the provided location to search
	 ...
	 * @param locationThe location to search from
	 * @param maxDistance Maximum distance around the provided location to search
	 * @return UVVillage object closest to the provided location. Null if no UVVillages in range.
	 */
	public UVVillage getClosestVillageToLocation(Location location, int maxDistance) {
		...
		for(Map.Entry<String, UVVillage> villageEntry : _villages.entrySet()) {
			double distance = location.distanceSquared(villageEntry.getValue().getLocation());
	...
	public Map<String, UVVillage> getVillagesNearLocation(Location location, int maxDistance) {
		...
		for(Map.Entry<String, UVVillage> villageEntry : _villages.entrySet()) {
			if(location.distanceSquared(villageEntry.getValue().getLocation()) < maxDistance * maxDistance) {
	...
	/**
	 * Step through our UVVillages and update their data from the nearest core village (if there is one).
	 */
	 ...
	 * @return A Configuration-friendly string-object map of villages for saving.
	 */
